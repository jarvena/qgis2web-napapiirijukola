...
var map = new ol.Map({
  ...
  view: new ol.View({
    ...
    projection: new ol.proj.Projection({
      code: 'EPSG:3067',
      extent: [25.518837, 66.504707, 754341.000000, 7800842.000000],
      units: 'm'
    })
  })
});
...
map.getView().fit([429985.819415, 7375183.852113, 445022.067948, 7384215.033276], map.getSize());
...
map.on("rendercomplete", function (evt) {
  if (!attributionComplete) {
    ...
    authorAttribution.innerHTML = 'built by <a href="https://github.com/jarvena/">jarvena</a> | '
